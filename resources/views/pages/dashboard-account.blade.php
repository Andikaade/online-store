            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <!-- Perbaikan: Mengubah '<div div' menjadi '<div' biasa -->
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="name">Your Name</label>
                      <input type="text" class="form-control" id="name" name="name" value="Nama Kamu" />
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="email" name="email" value="Email Kamu" />
                    </div>
                  </div>
